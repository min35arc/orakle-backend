 ...
 * ラグナ（アセンダント）計算
 * 正しい手順:
 *   1. swe_houses(jd, lat, lon, 'P') でトロピカルのアセンダントを取得
 *   2. swe_get_ayanamsa_ut(jd) でアヤナームシャを取得
 *   3. トロピカル - アヤナームシャ = シデリアルラグナ
 *
 * ※ swe_houses の正しいシグネチャは (tjd_ut, geolat, geolon, hsys)
 *    iflag引数は不要（あると geolat に 0 が入り結果がずれる）
 */
