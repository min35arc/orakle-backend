...
// ─── 鑑定文生成テスト（ブラウザで確認用） ───────────────────
// GET /api/test-reading?year=2003&month=10&day=5&hour=20&minute=8&tz=9&lat=36.34&lon=140.45&qid=career_1
app.get('/api/test-reading', async (req, res) => {
  try {
    ...
    const readingText  = await generateReading(qid, dashaResult.summaryForAI, {});
